  ...
  <html class="no-js"  <?php language_attributes(); ?>>
	...
	<head>
		...
		<?php wp_head();
			...
			echo '<style>
	        body.page-template-template-general .general-header-bg,
	        body.page-template-template-portfolio .general-header-bg,
	        body.page-template-template-case-studies .general-header-bg
	        {
		...
		<div class="off-canvas-wrapper">
			...
			<div class="off-canvas-content" data-off-canvas-content>
			   ...
			   <div class="page-header-outer">
			   	<div class="rellax general-header-bg"></div>
