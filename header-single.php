  ...
  <html class="no-js"  <?php language_attributes(); ?>>
	...
	<head>
		...
		<?php wp_head();
			...
			echo '<style>
			body.single .page-header-outer
			{
				background:url('. $feat_image_small .') top right no-repeat;
	        ...
	        @media only screen and (min-width:768px){
				body.single .page-header-outer
				{
					background:url('. $feat_image_large .') bottom right no-repeat;
	...
	<body <?php body_class(); ?>>
		...
		<div class="off-canvas-wrapper">
			...
			<div class="off-canvas-content" data-off-canvas-content>
			   ...
			   <div class="page-header-outer white-scrim">
